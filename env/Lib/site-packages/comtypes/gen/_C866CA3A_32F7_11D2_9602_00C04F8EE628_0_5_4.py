...
__all__ = [
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SWTDeleted', 'SPAS_PAUSE',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SPAR_Low',
    'DISPID_SVPause', 'SpeechEngineConfidence',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SPACommit',
    'DISPID_SCSBaseStream', 'SGRSTTDictation',
    'DISPID_SVEVoiceChange', 'DISPID_SDKEnumKeys', 'SPAUDIOOPTIONS',
    'ISpeechPhraseProperty', 'DISPID_SPPParent', 'DISPID_SPRsItem',
    'DISPID_SGRsAdd', 'SP_VISEME_8',
    'DISPID_SASCurrentDevicePosition', 'SGDSActive',
    'DISPID_SGRSTWeight', 'SDTPronunciation',
    'DISPID_SLWPronunciations', 'SRESoundEnd',
    'DISPID_SpeechPhraseElement', 'ISpeechLexiconPronunciation',
    'SPEI_RESERVED5', 'SPSMF_SRGS_SAPIPROPERTIES', 'SVSFNLPMask',
    'tagSPPROPERTYINFO', 'ISpPhoneticAlphabetConverter',
    'SVEEndInputStream', 'SPSNotOverriden',
    'DISPID_SOTGetDescription', 'DISPID_SGRClear', 'SPVISEMES',
    'eWORDTYPE_ADDED', 'SVSFVoiceMask', 'DISPID_SRGReset',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'ISpeechVoiceStatus',
    'DISPID_SPAPhraseInfo', 'SPFM_OPEN_READWRITE', 'SRCS_Enabled',
    'DISPID_SpeechGrammarRuleStateTransition', 'SVSFParseMask',
    'DISPID_SRGSetWordSequenceData', 'SpeechInterference',
    'SpeechDictationTopicSpelling', 'DISPID_SOTId',
    'DISPID_SPEEngineConfidence', 'SPCT_SLEEP', 'SECLowConfidence',
    'DISPID_SpeechGrammarRules', 'DISPID_SBSWrite',
    'DISPID_SRRGetXMLErrorInfo', 'eLEXTYPE_PRIVATE7',
    'DISPID_SpeechPhraseProperty', 'DISPID_SRCEStartStream',
    'SP_VISEME_15', 'SVEPhoneme', 'SREPhraseStart', 'SPVOICESTATUS',
    'DISPID_SpeechRecoContext', 'SP_VISEME_10', 'SPEI_WORD_BOUNDARY',
    'DISPID_SVWaitUntilDone', 'ISpeechRecoContext',
    'eLEXTYPE_PRIVATE16', 'DISPID_SVEStreamEnd', 'SFTSREngine',
    'SP_VISEME_17', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SRCCreateGrammar', 'SVP_7', 'DISPID_SOTSetId',
    'SPPS_Noun', 'DISPID_SRSetPropertyNumber',
    'DISPID_SRSCurrentStreamNumber', 'SRERecognition',
    'ISpRecoResult', 'DISPID_SABIMinNotification',
    'SAFT11kHz8BitMono', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SLWs_NewEnum', 'DISPID_SRCEAdaptation',
    'DISPID_SPRNumberOfElements', 'ISpeechResourceLoader',
    'DISPID_SLWLangId', 'SpeechPropertyResourceUsage',
    'SpeechAudioFormatGUIDWave', 'DISPID_SWFEFormatTag',
    'SPEI_MIN_SR', 'DISPID_SGRsDynamic', 'SVSFParseAutodetect',
    'DISPID_SDKSetLongValue', 'SPSHORTCUTPAIR', 'ISpDataKey',
    'SPEI_INTERFERENCE', 'DISPID_SRCRequestedUIType',
    'SpeechCategoryAudioIn', 'ISpeechGrammarRule',
    'DISPID_SMSSetData', 'DISPID_SVESentenceBoundary',
    'DISPID_SpeechGrammarRule', 'ISpeechGrammarRules',
    'DISPID_SVVolume', 'DISPID_SAFSetWaveFormatEx', 'DISPID_SRCVoice',
    'DISPID_SWFEBitsPerSample', 'SPEVENT', 'ISpRecoCategory',
    'SPSVerb', 'ISpObjectWithToken', 'DISPID_SGRs_NewEnum',
    'DISPID_SMSAMMHandle', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SASCurrentSeekPosition', 'SPDKL_CurrentConfig',
    'SPVPRI_ALERT', 'DISPIDSPTSI', 'SRERecoOtherContext',
    'SPLEXICONTYPE', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SRGCmdLoadFromObject', 'SpeechMicTraining',
    'DISPID_SVSLastResult', 'SpeechCategoryRecoProfiles',
    'DISPID_SRCEInterference', 'SGRSTTRule', 'SVF_None', 'SpVoice',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SVP_4', 'SP_VISEME_20',
    'SpeechAllElements', 'DISPID_SpeechRecoContextEvents',
    'SPSTREAMFORMATTYPE', 'DISPID_SRSNumberOfActiveRules',
    'SGRSTTEpsilon', 'ISpNotifyTranslator', 'SDTProperty',
    'SpeechTokenShellFolder', 'SPSMF_SAPI_PROPERTIES',
    'SPAO_RETAIN_AUDIO', 'DISPID_SPRulesItem',
    'SAFTCCITT_ALaw_11kHzStereo', 'SREStreamEnd', 'DISPID_SMSGetData',
    'DISPID_SRAudioInput', 'SDA_One_Trailing_Space',
    'DISPID_SDKSetStringValue', 'SPEI_MAX_SR', 'DISPID_SGRAddState',
    'SPPS_LMA', 'SPWORDLIST', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SpeechLexiconWords', 'DISPID_SRGSetTextSelection',
    'SPDKL_LocalMachine', 'DISPID_SRCSetAdaptationData',
    'SWPUnknownWordPronounceable', 'SPAUDIOBUFFERINFO',
    'SpeechVisemeType', 'SPWF_INPUT', 'DISPID_SRRTimes',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SPERetainedStreamOffset',
    'SVP_9', 'ISpStreamFormat', 'SGDSActiveWithAutoPause',
    'DISPID_SLWsCount', 'eLEXTYPE_RESERVED4', 'STCAll', 'SPSMF_UPS',
    'SGDisplay', 'SPCS_ENABLED', 'DISPID_SPPName',
    'DISPID_SPEAudioTimeOffset', 'SGRSTTTextBuffer', 'SpeechRunState',
    'DISPID_SPRuleEngineConfidence', 'SAFT22kHz16BitMono',
    'SPFILEMODE', 'SpeechVoicePriority', 'DISPID_SPISaveToMemory',
    'DISPID_SPERequiredConfidence', 'eLEXTYPE_RESERVED8',
    'SRAInterpreter', 'SpeechGrammarState', 'ISpeechPhraseAlternates',
    'DISPID_SDKEnumValues', 'DISPID_SBSRead', 'SpeechRecognitionType',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SPILanguageId',
    'DISPID_SpeechObjectToken', 'SPEI_END_SR_STREAM',
    'SPPS_NotOverriden', 'DISPID_SASFreeBufferSpace', 'SPPHRASERULE',
    'ISpeechPhraseReplacements', 'DISPID_SGRAddResource',
    'SpeechCategoryPhoneConverters', 'eLEXTYPE_PRIVATE14',
    'SVSFIsFilename', 'SLOStatic', 'SpWaveFormatEx', 'ISpeechDataKey',
    'DISPIDSPTSI_ActiveOffset', 'SP_VISEME_1', 'DISPID_SGRSTRule',
    'DISPID_SPEAudioSizeTime', 'SpeechGrammarTagDictation',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SRGDictationUnload', 'DISPID_SPAStartElementInResult',
    'DISPID_SPELexicalForm', 'DISPID_SRGCommit', 'SGSDisabled',
    'SPGS_ENABLED', 'DISPID_SRGCmdLoadFromFile', 'SSFMCreateForWrite',
    'DISPID_SPEDisplayAttributes', 'ISpeechLexicon',
    'DISPID_SPRuleParent', 'SpeechAudioProperties',
    'SPWORDPRONUNCIATIONLIST', 'eLEXTYPE_RESERVED6',
    '_ISpeechRecoContextEvents', 'DISPID_SVEViseme',
    'DISPID_SRRecognizer', 'DISPID_SVPriority', 'UINT_PTR',
    'SPEI_RESERVED6', 'SDTAll', 'SRCS_Disabled', 'DISPID_SOTRemove',
    'SAFT12kHz16BitMono', 'DISPID_SPPsItem',
    'ISpeechRecognizerStatus', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SGRSTPropertyId', 'eLEXTYPE_RESERVED9',
    'DISPID_SPRFirstElement', 'SPPROPERTYINFO', 'SVP_14',
    'DISPID_SRCEEnginePrivate', 'eLEXTYPE_RESERVED10',
    'ISpeechPhraseInfo', 'ISpShortcut', 'DISPID_SpeechLexicon',
    'SVP_6', 'DISPID_SpeechFileStream',
    'SpeechPropertyComplexResponseSpeed', 'SpObjectTokenCategory',
    'SPEI_PHONEME', 'tagSTATSTG', 'SpShortcut',
    'SAFT32kHz16BitStereo', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SPEI_RESERVED3', 'DISPID_SGRId', 'DISPID_SRIsShared',
    'SDTReplacement', 'SPRST_INACTIVE',
    'DISPID_SRCRetainedAudioFormat', 'ISpeechPhraseInfoBuilder',
    'DISPID_SOTCGetDataKey', 'SPFM_CREATE_ALWAYS',
    'SAFTADPCM_44kHzMono', 'DISPID_SGRInitialState',
    'STCRemoteServer', 'eLEXTYPE_PRIVATE6',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SLPPhoneIds',
    'DISPIDSPTSI_SelectionOffset', 'SpAudioFormat',
    'SpStreamFormatConverter', 'ISpSerializeState',
    'SREPropertyStringChange', 'DISPID_SRGDictationSetState',
    'SpSharedRecoContext', 'SPEI_PHRASE_START', 'eLEXTYPE_RESERVED7',
    'SPEI_HYPOTHESIS', 'SPVPRIORITY', 'DISPID_SRCBookmark',
    'SpeechWordType', 'SpFileStream', 'DISPID_SRGRecoContext',
    'SPEI_SOUND_END', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SVSVisemeId', 'DISPID_SWFEBlockAlign',
    'SpeechAudioFormatType', 'SRTReSent',
    'ISpPhoneticAlphabetSelection', 'DISPID_SPIRetainedSizeBytes',
    'SSTTDictation', 'DISPID_SPRuleName', 'SpeechLoadOption',
    'SPEI_SR_PRIVATE', 'SAFT24kHz8BitStereo',
    'DISPID_SRGetPropertyNumber', 'SAFT16kHz16BitMono', 'SPAS_STOP',
    'DISPID_SPEsItem', 'SAFT32kHz8BitStereo', 'SAFT44kHz16BitStereo',
    'SPLO_DYNAMIC', 'SREHypothesis', 'DISPID_SGRSTransitions',
    'DISPID_SVSInputWordLength', 'eLEXTYPE_APP', 'SpCustomStream',
    'DISPID_SRGetFormat', 'DISPID_SAEventHandle', 'WAVEFORMATEX',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SPRsCount', 'eLEXTYPE_PRIVATE3', 'SRAImport',
    'SPINTERFERENCE_NONE', 'SRAORetainAudio', 'SPRULE',
    'STSF_FlagCreate', 'DISPID_SPIAudioSizeTime',
    'DISPID_SWFEAvgBytesPerSec', 'SASClosed', 'SAFT22kHz16BitStereo',
    'ISpeechRecoResult2', 'DISPID_SPEDisplayText', 'SVEWordBoundary',
    'SAFT16kHz8BitStereo', 'SVESentenceBoundary',
    'DISPID_SRCEPropertyNumberChange', 'SP_VISEME_9', 'SVSFlagsAsync',
    'SPAS_CLOSED', 'DISPID_SLGetGenerationChange',
    'DISPID_SpeechWaveFormatEx', 'SPAR_Unknown', 'SpNotifyTranslator',
    'SRERequestUI', 'ISpeechLexiconPronunciations',
    'SpeechPropertyHighConfidenceThreshold', 'Speech_Default_Weight',
    'DISPID_SABIEventBias', 'SVEPrivate', 'DISPID_SVGetAudioOutputs',
    'SWTAdded', 'DISPID_SDKGetBinaryValue', 'DISPID_SRCRecognizer',
    'STCInprocServer', 'SPEI_SR_RETAINEDAUDIO', 'SPAR_Medium',
    'SAFTCCITT_uLaw_8kHzMono', 'SP_VISEME_19',
    'DISPID_SPIReplacements', 'eLEXTYPE_PRIVATE5',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SVSFNLPSpeakPunc',
    'SPSInterjection', 'SP_VISEME_6', 'DISPID_SLGenerationId',
    'DISPID_SPPNumberOfElements', 'SPAUDIOSTATUS',
    'DISPID_SpeechAudioStatus', 'DISPID_SGRsCount',
    'SDA_Consume_Leading_Spaces', 'SSFMOpenReadWrite', 'SVP_1',
    'SpeechPropertyNormalConfidenceThreshold', 'SP_VISEME_12',
    'SpeechAudioFormatGUIDText', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SpeechAudioFormat', 'ISpRecognizer', 'SAFT24kHz16BitMono',
    'SPXRO_SML', 'ISpNotifySource', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SVEBookmark', 'SPPS_RESERVED2',
    'SWPKnownWordPronounceable', 'SpeechStreamFileMode',
    'SREStateChange', 'SAFT22kHz8BitMono', 'SAFTADPCM_44kHzStereo',
    'SPPS_Unknown', 'SpLexicon', 'SSFMCreate', 'DISPID_SPRuleId',
    'DISPID_SOTDisplayUI', 'DISPID_SRRSaveToMemory',
    'SpeechLexiconType', 'SPVPRI_OVER', 'DISPID_SVEStreamStart',
    'ISpeechLexiconWords', 'SAFT8kHz16BitStereo',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SRProfile',
    'IInternetSecurityManager', 'SPRST_ACTIVE_ALWAYS',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SRStatus', 'SVSFParseSapi',
    'DISPID_SpeechPhraseProperties', 'SAFT8kHz8BitStereo',
    'SDTAlternates', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SPIRule', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SPEI_SOUND_START', 'eLEXTYPE_PRIVATE1', 'DISPID_SGRSTType',
    'DISPID_SLPLangId', 'SpPhraseInfoBuilder', 'DISPID_SPIGetText',
    'SREStreamStart', 'DISPID_SAVolume', 'DISPID_SPPFirstElement',
    'DISPID_SRCEFalseRecognition', 'SAFT48kHz8BitMono',
    'DISPID_SPPValue', 'SPEI_REQUEST_UI', 'SPBO_PAUSE',
    'DISPID_SRCResume', 'DISPID_SFSOpen', 'SRTSMLTimeout',
    'SpTextSelectionInformation', 'SAFT32kHz8BitMono',
    'STSF_CommonAppData', 'SpeechRegistryLocalMachineRoot',
    'SAFTADPCM_11kHzMono', 'ISpeechLexiconWord',
    'DISPID_SPPs_NewEnum', 'SAFTADPCM_11kHzStereo', 'SPPS_Modifier',
    'SpeechFormatType', 'SAFT8kHz8BitMono', 'SAFTDefault',
    'SPSFunction', 'DISPID_SPAs_NewEnum', 'SASRun', 'SP_VISEME_3',
    'SpeechUserTraining', 'SPEI_START_INPUT_STREAM', 'SP_VISEME_16',
    'SAFTCCITT_uLaw_11kHzStereo', 'SPWT_LEXICAL',
    'SDA_Two_Trailing_Spaces', 'SAFTADPCM_8kHzStereo',
    'SAFT8kHz16BitMono', 'SP_VISEME_2', 'SPBO_AHEAD',
    'DISPID_SVSLastStreamNumberQueued', 'SPAO_NONE', 'SpObjectToken',
    'SVP_15', 'SPPHRASE', 'DISPID_SpeechMemoryStream', 'SITooQuiet',
    'SVSFIsXML', 'SRSActiveAlways', 'DISPID_SPIElements',
    'SPPS_Function', 'SPEI_VOICE_CHANGE', 'SpeechCategoryRecognizers',
    'SPEI_ADAPTATION', 'SPEVENTSOURCEINFO', 'Speech_StreamPos_Asap',
    'DISPID_SGRSTsItem', 'SVEVoiceChange',
    'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SpeechObjectTokens', 'DISPID_SDKGetlongValue',
    'SPSHT_NotOverriden', 'DISPID_SABufferInfo',
    'SpeechRuleAttributes', 'DISPID_SRCRetainedAudio',
    'SRADefaultToActive', 'SVP_3', 'ISpeechFileStream',
    'DISPID_SRCEAudioLevel', 'DISPID_SPRuleNumberOfElements',
    'SPGS_EXCLUSIVE', 'SPSUnknown', 'SAFT44kHz8BitStereo',
    'DISPID_SPPEngineConfidence', 'DISPID_SRGRules',
    'DISPID_SLPSymbolic', 'SREPropertyNumChange', 'SpeechVoiceEvents',
    'SpeechDataKeyLocation', 'SPCATEGORYTYPE', 'SVSFUnusedFlags',
    'SAFT44kHz8BitMono', 'SPGRAMMARSTATE', 'ISpResourceManager',
    'SPWT_DISPLAY', 'SVEBookmark', 'DISPID_SpeechPhoneConverter',
    'SpInProcRecoContext', 'DISPID_SPEActualConfidence',
    'ISpeechPhraseAlternate', 'SVEAllEvents', 'eLEXTYPE_PRIVATE12',
    'DISPID_SRSClsidEngine', 'ISpeechAudioFormat',
    'SPDKL_DefaultLocation', 'SPSEMANTICFORMAT',
    'DISPID_SpeechRecognizer', 'DISPID_SRCERequestUI',
    'ISpeechMemoryStream', 'SRSEDone', 'SVEAudioLevel',
    'DISPID_SPEs_NewEnum', 'DISPID_SVGetVoices',
    'ISpeechGrammarRuleState', 'SDTDisplayText',
    'SpeechCategoryAudioOut', 'SPPS_RESERVED3',
    'DISPID_SpeechGrammarRuleState', 'SpPhoneticAlphabetConverter',
    'SPEI_MAX_TTS', 'DISPID_SRCERecognizerStateChange',
    'SGDSInactive', 'DISPID_SVSInputSentencePosition',
    'SPSHORTCUTTYPE', 'DISPID_SGRsCommitAndSave',
    'SRSInactiveWithPurge', 'SPEI_RESERVED2', 'SpeechRuleState',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SRRTLength',
    'SPRST_NUM_STATES', 'DISPID_SRRAudioFormat', 'DISPID_SOTCSetId',
    'DISPID_SPAsItem', 'IInternetSecurityMgrSite',
    'DISPID_SOTGetAttribute', 'DISPID_SRSAudioStatus',
    'DISPID_SVAudioOutputStream', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SPRText', 'SPEI_SENTENCE_BOUNDARY', 'DISPID_SGRsItem',
    'DISPID_SOTRemoveStorageFileName', 'STCLocalServer',
    'SPFM_OPEN_READONLY', 'SpeechPropertyLowConfidenceThreshold',
    'SDTAudio', 'SpMMAudioEnum', 'SECFEmulateResult',
    'SPXRO_Alternates_SML', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SLPsItem', 'SAFT11kHz16BitMono', 'SpeechCategoryVoices',
    'DISPID_SPEsCount', 'Speech_Max_Pron_Length', 'SPPS_SuppressWord',
    'SPRECORESULTTIMES', 'DISPID_SPPChildren',
    'ISpeechObjectTokenCategory', 'SSFMOpenForRead',
    'DISPID_SPPConfidence', 'DISPID_SRSetPropertyString',
    'tagSPTEXTSELECTIONINFO', 'ISpeechGrammarRuleStateTransition',
    'ISpeechMMSysAudio', 'SECFIgnoreKanaType', 'DISPID_SVStatus',
    'DISPID_SLWWord', 'DISPID_SVEWord', 'SREPrivate',
    'eLEXTYPE_PRIVATE15', 'SpeechRecoContextState',
    'DISPID_SVGetAudioInputs', 'SpeechTokenKeyUI',
    'DISPID_SPRules_NewEnum', 'SRSActive', 'DISPID_SpeechAudio',
    'STSF_AppData', 'SPFM_NUM_MODES',
    'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SOTMatchesAttributes', 'SAFTGSM610_11kHzMono',
    'SRESoundStart', 'SVP_2', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SRCESoundStart', 'SPEI_END_INPUT_STREAM', 'SVP_10',
    'DISPID_SRCreateRecoContext', 'SRARoot',
    'DISPID_SpeechVoiceStatus', 'SREBookmark', 'SpeechDiscardType',
    'SPDATAKEYLOCATION', 'SPRECOGNIZERSTATUS', 'SINone',
    'SpeechPartOfSpeech', 'SAFT48kHz8BitStereo', 'SGSExclusive',
    '_RemotableHandle', 'DISPID_SPIGrammarId',
    'DISPID_SRGetPropertyString', 'DISPID_SpeechPhraseReplacement',
    'SAFTADPCM_22kHzStereo', 'SRADynamic', 'SPEI_START_SR_STREAM',
    'ISpeechPhraseElements', 'SpeechVisemeFeature', 'SVSFIsNotXML',
    'DISPID_SVEEnginePrivate', 'DISPID_SOTGetStorageFileName',
    'DISPID_SVResume', 'DISPID_SVAudioOutput', 'SECHighConfidence',
    'ISpRecoContext2', 'DISPID_SpeechLexiconProns', 'SRTAutopause',
    'SPCT_SUB_DICTATION', 'SPBO_NONE', 'SPAS_RUN',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SPIStartTime',
    'SAFTCCITT_ALaw_11kHzMono', 'SPEI_SR_BOOKMARK',
    'DISPID_SVDisplayUI', 'ISpEventSink', 'SAFT24kHz8BitMono',
    'ISpeechCustomStream', 'SITooSlow', 'SECFIgnoreCase',
    'SREFalseRecognition', 'SPRST_INACTIVE_WITH_PURGE',
    'SAFTADPCM_22kHzMono', 'SPPS_RESERVED4', 'SpPhoneConverter',
    'DISPID_SDKGetStringValue', 'SAFT12kHz8BitStereo', 'SITooFast',
    'DISPID_SOTDataKey', 'LONG_PTR', 'SpCompressedLexicon',
    'SGLexicalNoSpecialChars', 'SDA_No_Trailing_Space',
    'SREAudioLevel', 'SPCONTEXTSTATE', 'DISPID_SVEPhoneme', 'SVP_21',
    'SAFT48kHz16BitMono', 'DISPID_SpeechAudioBufferInfo',
    'SPSModifier', 'SASPause', 'SAFT12kHz16BitStereo', 'SREAllEvents',
    'DISPID_SGRSTs_NewEnum', 'SGSEnabled', 'SpeechTokenValueCLSID',
    'SpeechPropertyAdaptationOn', 'SGRSTTWord', 'DISPID_SGRsCommit',
    'ISpNotifySink', 'SpeechVoiceSkipTypeSentence',
    'SSSPTRelativeToStart', 'DISPID_SRIsUISupported',
    'DISPID_SDKCreateKey', 'DISPID_SLWType',
    'SPEI_PROPERTY_NUM_CHANGE', 'SPPS_Verb', 'SRTStandard',
    'ISpRecoGrammar2', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SGRSTPropertyName', 'SPBOOKMARKOPTIONS',
    'DISPID_SPCLangId', 'SPWORDTYPE', 'ISpMMSysAudio',
    'SAFT32kHz16BitMono', 'SLTApp', 'DISPID_SRDisplayUI',
    'ISpeechRecoResult', 'SBOPause', 'SREAdaptation',
    'DISPID_SPEPronunciation', 'ISpStream', 'SPWORDPRONOUNCEABLE',
    'SVP_17', 'SPDKL_CurrentUser', 'ISpeechRecognizer',
    'SpeechAddRemoveWord', 'SVP_8', 'DISPID_SVGetProfiles',
    'SpeechRetainedAudioOptions', 'DISPID_SGRSTsCount',
    'ISpeechPhraseRule', 'SAFT12kHz8BitMono',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SBSSeek',
    'SpNullPhoneConverter', 'SpeechBookmarkOptions', 'DISPID_SLPType',
    'SpeechPropertyResponseSpeed', 'SINoSignal',
    'ISpeechRecoResultTimes', 'DISPID_SRState', 'SBONone',
    'SAFT44kHz16BitMono', 'SpeechTokenContext', 'SPXMLRESULTOPTIONS',
    'SVP_5', 'SpeechAudioVolume', 'DISPID_SVSLastBookmark',
    'SpeechGrammarWordType', 'SP_VISEME_7', 'ISpeechRecoGrammar',
    'DISPID_SpeechBaseStream', 'DISPID_SRRGetXMLResult',
    '_SPAUDIOSTATE', 'SAFTCCITT_ALaw_8kHzMono', 'SVP_18',
    'SPVPRI_NORMAL', 'DISPID_SRCCmdMaxAlternates',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPPHRASEELEMENT', 'SPSNoun',
    'SPPS_RESERVED1', 'SPEI_TTS_BOOKMARK', 'SPCT_SUB_COMMAND',
    'SPSHORTCUTPAIRLIST', 'SP_VISEME_13', 'ISpXMLRecoResult',
    'SP_VISEME_11', 'DISPID_SPCPhoneToId', 'SLODynamic',
    'SPEI_VISEME', 'DISPID_SRRRecoContext', 'ISpeechObjectToken',
    'ISpeechTextSelectionInformation', 'SDKLCurrentUser',
    'SAFTGSM610_44kHzMono', 'ISpStreamFormatConverter',
    'DISPID_SMSALineId', 'SVP_13', 'DISPID_SpeechPhraseRules',
    'SP_VISEME_4', 'SWPUnknownWordUnpronounceable', 'ISpRecoGrammar',
    'DISPID_SRCEHypothesis', 'DISPID_SGRsFindRule',
    'SPINTERFERENCE_LATENCY_WARNING', 'SPINTERFERENCE',
    'eLEXTYPE_PRIVATE20', 'DISPID_SRAudioInputStream', 'SVF_Stressed',
    'SPAR_High', 'SGRSTTWildcard', 'SPSEMANTICERRORINFO',
    'DISPID_SVEventInterests', 'SDTRule', 'DISPID_SASetState',
    'SPWORDPRONUNCIATION', 'DISPID_SPIEnginePrivateData',
    'DISPID_SpeechVoiceEvent', 'DISPID_SLPs_NewEnum',
    'DISPID_SPRuleConfidence', 'SPRST_ACTIVE', 'ISpVoice',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SRCEBookmark',
    'DISPID_SFSClose', 'SRTEmulated', 'SpStream', 'SVPNormal',
    'DISPID_SAFType', 'SREInterference', 'DISPIDSPRG',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPWF_SRENGINE',
    'DISPID_SPAsCount', 'DISPID_SPRulesCount', 'SP_VISEME_5',
    'SSTTTextBuffer', 'SPRS_ACTIVE_USER_DELIMITED',
    'SVSFPurgeBeforeSpeak', 'SVSFPersistXML', 'SPRS_INACTIVE',
    ...
    'SpeechEmulationCompareFlags', 'DISPID_SpeechCustomStream',
    'DISPID_SABIBufferSize', 'ISpRecognizer3', 'DISPID_SPCIdToPhone',
    'DISPID_SOTsCount', 'DISPID_SDKSetBinaryValue',
    'DISPID_SRSSupportedLanguages', 'eLEXTYPE_PRIVATE2', 'SLTUser',
    'DISPID_SRRAlternates', 'STCInprocHandler',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'ISpeechWaveFormatEx',
    'SPSSuppressWord', 'SPEI_RECO_STATE_CHANGE', 'SPEI_MIN_TTS',
    'DISPID_SVSLastBookmarkId', 'SVEViseme', 'SRATopLevel',
    'SPPS_Noncontent', 'SVPAlert', 'DISPID_SpeechMMSysAudio', 'SVP_0',
    'DISPID_SOTIsUISupported', 'SINoise', 'DISPID_SABufferNotifySize',
    'SPCT_DICTATION', 'SpResourceManager', 'eLEXTYPE_PRIVATE13',
    'DISPID_SPRuleFirstElement', 'DISPID_SOTsItem', 'DISPID_SVRate',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPEI_UNDEFINED', 'SPRS_ACTIVE',
    'SpeechSpecialTransitionType', 'SVP_16',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SLPsCount',
    'ISpeechObjectTokens', 'SVSFDefault', 'SPINTERFERENCE_NOISE',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SVSRunningState', 'ISpeechAudioStatus', 'SPEVENTENUM',
    'SPGRAMMARWORDTYPE', 'ISpeechPhoneConverter',
    'DISPID_SRCEPhraseStart', 'SRSInactive', 'SpMemoryStream',
    'DISPID_SLWsItem', 'SPEI_RECOGNITION', 'SpSharedRecognizer',
    'eLEXTYPE_PRIVATE4', 'DISPID_SAStatus', 'Speech_Max_Word_Length',
    'SPAUDIOSTATE', 'SFTInput', 'SPSERIALIZEDPHRASE',
    'ISpeechBaseStream', 'SPTEXTSELECTIONINFO',
    'SpeechRecoProfileProperties', 'SECFDefault',
    'SECFNoSpecialChars', 'SAFT24kHz16BitStereo', 'SP_VISEME_14',
    'SPSLMA', 'DISPID_SRCEPropertyStringChange', 'SP_VISEME_21',
    'DISPID_SLGetWords', 'ISpeechPhraseRules', 'SECNormalConfidence',
    'DISPID_SMSADeviceId', 'DISPID_SDKDeleteKey',
    'SAFT11kHz8BitStereo', 'SAFTGSM610_22kHzMono',
    'eLEXTYPE_PRIVATE9', 'SpUnCompressedLexicon', 'SPRECOSTATE',
    'DISPID_SpeechLexiconPronunciation', 'eLEXTYPE_USER',
    'SpeechRegistryUserRoot', 'DISPID_SpeechRecoResult',
    'ISpRecognizer2', 'DISPID_SGRSTText',
    'SPEI_PROPERTY_STRING_CHANGE', 'SpeechAudioState',
    'ISpRecoContext', 'DISPID_SVIsUISupported',
    'DISPID_SRRTOffsetFromStart', 'SVP_20', 'SAFT16kHz16BitStereo',
    'SAFT48kHz16BitStereo', 'IEnumString', 'DISPID_SGRSRule',
    'SpeechCategoryAppLexicons', 'ISpeechXMLRecoResult',
    'DISPID_SRCERecognition', 'DISPID_SLPPartOfSpeech',
    'DISPID_SWFESamplesPerSec', 'DISPID_SPRs_NewEnum',
    'SPEI_TTS_PRIVATE', 'SPPARTOFSPEECH', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SWFEChannels', 'eLEXTYPE_PRIVATE11',
    'DISPID_SpeechLexiconWord', 'eLEXTYPE_USER_SHORTCUT',
    'SECFIgnoreWidth', 'DISPID_SPIEngineId',
    'DISPID_SOTCreateInstance', 'SITooLoud',
    'SAFTCCITT_ALaw_44kHzMono', 'SPFM_CREATE', 'DISPID_SASState',
    'DISPID_SGRSTNextState', 'DISPID_SPIProperties',
    'eLEXTYPE_PRIVATE10', 'DISPID_SOTs_NewEnum',
    'DISPID_SVAlertBoundary', 'DISPID_SPIAudioSizeBytes',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SOTCategory',
    'SpeechVoiceSpeakFlags', 'SPLOADOPTIONS', 'SRTExtendableParse',
    'ISpeechRecoResultDispatch', 'SpeechDisplayAttributes',
    'DISPID_SGRSTPropertyValue', 'ISpeechPhraseProperties',
    'DISPID_SRCPause', 'SPSHT_Unknown', 'SPPS_Interjection',
    'SpeechWordPronounceable', 'SPINTERFERENCE_TOOSLOW',
    'SpeechGrammarTagWildcard', 'SPBINARYGRAMMAR', 'IStream',
    'DISPID_SREmulateRecognition', 'SAFT16kHz8BitMono',
    'DISPID_SpeechPhraseElements', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SRCAudioInInterferenceStatus', 'SAFTADPCM_8kHzMono',
    'SPADAPTATIONRELEVANCE', 'ISpPhoneConverter',
    'SpeechTokenKeyAttributes', 'DISPID_SVSPhonemeId', 'SPLO_STATIC',
    'DISPID_SPERetainedSizeBytes', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SRRDiscardResultInfo', 'IEnumSpObjectTokens',
    'SpMMAudioIn', 'SPPHRASEREPLACEMENT', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SGRName', 'eLEXTYPE_PRIVATE17',
    'SpeechTokenIdUserLexicon', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SDKDeleteValue', 'SSTTWildcard', 'SPRULESTATE',
    'STSF_LocalAppData', 'SpeechGrammarRuleStateTransitionType',
    'ISpeechVoice', 'SpeechTokenKeyFiles', 'eLEXTYPE_PRIVATE8',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SAFGuid',
    'DISPID_SRRSpeakAudio', 'SPCT_COMMAND', 'DISPID_SRGetRecognizers',
    'SVP_12', 'SAFTCCITT_ALaw_44kHzStereo', 'SVSFParseSsml',
    'DISPID_SVSInputSentenceLength', 'DISPID_SPARecoResult',
    'DISPID_SPEAudioStreamOffset', 'SGPronounciation', 'SVP_11',
    'DISPID_SASNonBlockingIO', 'SAFTCCITT_uLaw_8kHzStereo',
    'SAFT22kHz8BitStereo', 'SVF_Emphasis',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SPRDisplayAttributes',
    'SAFTNonStandardFormat', 'SPWORD', 'DISPID_SRRPhraseInfo',
    'DISPID_SRRSetTextFeedback', 'DISPID_SRGCmdSetRuleState',
    'SRAONone', '__MIDL_IWinTypes_0009', 'SpMMAudioOut',
    'SpeechRecoEvents', 'SVEStartInputStream', 'DISPID_SPPsCount',
    'DISPID_SRCState', 'DISPID_SOTCDefault', 'DISPID_SRRAudio',
    'DISPID_SPPId', 'SpeechVoiceCategoryTTSRate',
    'eLEXTYPE_PRIVATE18', 'ISpeechPhraseReplacement',
    'DISPID_SVVoice', 'DISPID_SOTCId', 'eLEXTYPE_LETTERTOSOUND',
    'SP_VISEME_18', 'SPRECOCONTEXTSTATUS', 'ISpObjectTokenCategory',
    'DISPID_SRSCurrentStreamPosition', 'SPEI_SR_AUDIO_LEVEL',
    'SP_VISEME_0', 'SPPHRASEPROPERTY', 'DISPID_SVSpeak',
    'SAFTNoAssignedFormat', 'SPBO_TIME_UNITS',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SRRTStreamTime', 'DISPID_SRGIsPronounceable',
    '_ISpeechVoiceEvents', 'SPWAVEFORMATTYPE',
    'DISPID_SLRemovePronunciation', 'SVP_19', 'SPWT_PRONUNCIATION',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SpeechDataKey',
    'DISPID_SOTCEnumerateTokens', 'SPINTERFERENCE_TOOQUIET',
    'SDKLLocalMachine', 'DISPID_SRGState',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SVSkip',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SpeechPhraseRule',
    'DISPID_SVSpeakStream', 'DISPID_SRCEEndStream',
    'eLEXTYPE_PRIVATE19', 'ISpAudio', 'DISPID_SLGetPronunciations',
    'DISPID_SRCEventInterests', 'Speech_StreamPos_RealTime',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SpeechObjectTokenCategory',
    'SVPOver', 'SPEI_RESERVED1', 'SDTLexicalForm', 'SPGS_DISABLED',
    'DISPID_SDKOpenKey', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SPRuleChildren', 'DISPID_SRCESoundEnd',
    'DISPID_SpeechVoice', 'SSSPTRelativeToEnd', 'SpInprocRecognizer',
    'SAFTExtendedAudioFormat', 'SpeechRecognizerState',
    'ISpEventSource', 'ISpGrammarBuilder', 'SPSHT_EMAIL',
    'DISPID_SRRTTickCount', 'ISpLexicon', 'DISPID_SBSFormat',
    'ISpeechAudioBufferInfo', 'SRAExport', 'SDKLCurrentConfig',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SpeechPhraseInfo',
    'ISpeechPhraseElement', 'SGDSActiveUserDelimited', 'ISpPhrase',
    'ISpeechAudio', 'SAFTGSM610_8kHzMono',
    'DISPID_SPIGetDisplayAttributes', 'SDKLDefaultLocation',
    'DISPIDSPTSI_SelectionLength', 'SPSERIALIZEDRESULT',
    'SAFT11kHz16BitStereo', 'ISpProperties', 'ISequentialStream',
    'DISPID_SVEAudioLevel', 'DISPID_SPANumberOfElementsInResult',
    'ISpObjectToken', 'eWORDTYPE_DELETED',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SASStop',
    'SRSEIsSpeaking', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SGRAttributes', 'DISPID_SVSInputWordPosition',
    'SpeechStreamSeekPositionType', 'DISPID_SRGDictationLoad',
    'DISPID_SADefaultFormat', 'DISPID_SRGId', 'SPCS_DISABLED',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SWFEExtraData',
    'ISpPhraseAlt', 'SpeechEngineProperties'
]

_check_version('1.2.0', 1614970331.065244)
